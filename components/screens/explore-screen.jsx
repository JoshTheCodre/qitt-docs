...
const suggestions = [
  ...
  //     { name: "Past Questions", icon: FileText },
  //     { name: "Lab Reports", icon: Microscope },
  //     { name: "Project Ideas", icon: Grid3X3 },
  //   ],
  // },
  // {
  //   title: "Free Resources",
  //   items: [
  //     { name: "Anatomy Atlas", icon: Microscope },
  //     { name: "Calculus Notes", icon: Calculator },
  //     { name: "Chemistry Guide", icon: BookOpen },
  //     { name: "Physics Lab", icon: FileText },
  //   ],
  // },
  // {
  ...
  //     { name: "Machine Learning", icon: Grid3X3 },
  //     { name: "Database Systems", icon: FileText },
  //     { name: "Legal Cases", icon: Scale },
  //   ],
  // },
];
...
export default function ExploreScreen({ user, onNavigate, onResourceSelect }) {
  ...
  useEffect(() => {
    fetchResources();
  }, [searchQuery, departmentFilter, levelFilter, priceFilter]);
              ...
              <div key={section.title}>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {section.items.map((item) => (
                    <Card
                      key={item.name}
                      className="rounded-xl cursor-pointer hover:shadow-lg transition-shadow bg-white"
                    >
